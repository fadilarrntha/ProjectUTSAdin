...
class data {
    ...
    function insert_kopi($nama, $bubuk, $berat, $alamat){
        mysqli_query($this->con, "insert into pesan values ('','$nama', '$bubuk', '$berat', '$alamat')");
    }
    ...
    function update_order($no, $nama, $bubuk, $berat, $alamat){
        mysqli_query($this->con, "UPDATE pesan SET nama='$nama', bubuk='$bubuk', berat='$berat', alamat='$alamat' WHERE no = '$no'");
    }
}
?>