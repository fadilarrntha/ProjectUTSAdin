        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="adjust-nav">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">FADILAR</a>
                </div>
            </div>
        </div>
        <!-- /. NAV TOP  -->
                        ...
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="../edituser.php?no=<?php echo $a ['no'] ?>" class="btn btn-primary btn-lg btn-block ">Edit</a>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $b ['bubuk'] ?></td>
                                    <td><?php echo $b ['berat'] ?><desc> gr</desc></td>
